    ...
    <div class="main">
        ...
        <div class="left1 bg-gray">
            <div class="float-right">
                <button @click="getMapData()" class="rounded-xl p-2 bg-black text-white">
                    Refresh
                </button>
            </div>
            <br />
                ...
                <table class="">
                    ...
                    <tr v-for="(data, index) in info.mapEventData" :key="data.id">
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="dataEvent" id="checkedData" v-model="info.checkedInfo"
                                v-bind:value="data.geom.coordinates" @change="showDataOnMap(index)" />
                        </td>
                    </tr>
                </table>
            </div>
...
async function getMapData(map: mapboxgl.Map) {
    ...
    info.mapEventData = await $fetch("http://localhost:3001/map/geom");
